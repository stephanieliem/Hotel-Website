...
<body>
	...
	<div class="col-md-6 col-md-offset-3">
		...
		<div class="col-md-6">
		<h2 style="text-align: right; vertical-align: middle;">Booking Details</h2>
		</div>
		</div>
		<h2 style="text-align: center;"> Thank You! Your reservation is now confirmed. </h2>
		<h1 style="text-align: center;">S2K</h1>
	...
	<div class="col-md-3">
	<a href="page=cetak.ph" class="btn btn-primary pull-right" style="margin-left: 5px;"><i class="fa fa-print fa-3x" aria-hidden="true"></i></a>
	<a type="button" href="index.php" class="btn btn-info pull-right" style="float: left;"><i class="fa fa-check-circle fa-3x" aria-hidden="true"></i></a>
	</div>
	</div>
</body>
</html>