...
if((isset($_FILES["file1"]["type"])) && (isset($_FILES["file2"]["type"])) && (isset($_FILES["file3"]["type"])))
{
		...
		&& in_array($file_extension3, $validextensions3)))
	{
		...
		else
		{
			...
			$qselect = mysqli_query($con,"UPDATE tipe SET nama='$nama', deskripsi = '$desc', image1 = '$imname1', image2 = '$imname2', image3 = '$imname3', harga= '$price', ukuran='$size' WHERE id_tipe = '".$id."'");  
			//echo 'success';
		}
	}
	else
